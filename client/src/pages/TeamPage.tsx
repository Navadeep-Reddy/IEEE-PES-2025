...
export default function Team() {
  ...
  const positions = {
    "EXECUTIVE BOARD": "top-[12%] right-[6%] sm:top-[12%] sm:right-[6%]",
    "PR TEAM": "top-[12%] left-[6%] sm:top-[12%] sm:left-[6%]",
    "DESIGN TEAM": "bottom-[10%] left-[8%] sm:bottom-[10%] sm:left-[8%]",
    "WEB MASTER TEAM": "bottom-[10%] right-[8%] sm:bottom-[10%] sm:right-[8%]",
    "EVENT MGMT":
      "bottom-[0%] left-1/2 transform -translate-x-1/2 sm:bottom-[0%]",
  };
    ...
    <div className="flex flex-col min-h-screen bg-[#102512] relative">
      ...
      <main className="flex-grow pt-28 px-4">
        ...
        <div className="overflow-x-auto">
          <div className="relative mx-auto w-[900px] sm:w-full max-w-[800px] h-[600px] sm:h-[650px] md:h-[700px] lg:h-[550px] z-10 -mt-4 md:-mt-8 overflow-visible">
            <svg
      ...
      <style>{`
        @keyframes glowText {
          0%, 1% { text-shadow: 0 0 4px #e6f86d, 0 0 8px #e6f86d; }
           { text-shadow: 0 0 6px #e6f86d, 0 0 10px #e6f86d; }
        }
