...
export default function Team() {
    ...
    const teams: Record<TeamName, string[]> = {
        "EXECUTIVE BOARD": [
            "Anshul L - Vice Chair",
            "Samyuktaa - Secretary",
    ...
    const positions: Record<TeamName, string> = {
    ...
    const toggleTeam = (team: TeamName) => setSelectedTeam(team);

    interface LinearLayoutElement {
        type: "chair" | "team";
        name: string;
        image?: string;
    }

    const linearLayoutElements: LinearLayoutElement[] = [
        {
            type: "chair",
            name: "Rithvikha V",
        ...
        <div className="flex flex-col min-h-screen bg-[#102512] relative">
            ...
            <main className="flex-grow pt-28 px-4">
                ...
                <p className="text-center text-[#e6f86d] text-md italic mb-8 animate-fade-in-up relative z-10 max-w-2xl mx-auto">
                    Fusing our energies dynamically to create electric
                    achievements and transformative outcomes.
                </p>
                ...
                {isSmallScreen ? (
                        ...
                        {linearLayoutElements.map((element, index) => (
                            <React.Fragment key={index}>
                                {element.type === "chair" ? (
                                    ...
                                    <div
                                        onClick={() =>
                                            toggleTeam(element.name as TeamName)
                                        }
                    ...
                    <div className="relative mx-auto w-full max-w-[800px] h-[600px] sm:h-[650px] md:h-[700px] lg:h-[550px] z-10 -mt-4 md:-mt-8 overflow-hidden">
                        ...
                        {Object.keys(teams).map((teamName) => (
                            <div
                                key={teamName}
                                onClick={() => toggleTeam(teamName as TeamName)}
                  ...
                  transition duration-300 hover:scale-105 shadow-md hover:shadow-lg ${
                      positions[teamName as TeamName]
                  }`}
                            >
                                        ...
                                        <li
                                            ...
                                            onClick={() =>
                                                setSelectedMember({
                                                    ...
                                                    image:
                                                        memberImages[name] ||
                                                        "/team/default.jpg", // Fallback image
                                                })
                                            }
